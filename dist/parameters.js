...
exports.useUpperCaseFistLetter = useUpperCaseFistLetter;
const styleTable = exports.styleTable = {
  ...
  nbPages: {
    ...
    background: 'linear-gradient(to top,rgb(188, 189, 189, 0.6),rgb(254, 254, 254))',
 ...
 * @returns {array} 
 */
function sortingData(dataRows, dataColumns, index, sorts) {
 ...
 * @returns {string} 
 */
function useUpperCaseFistLetter(word) {
